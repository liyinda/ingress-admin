        ...
        <td :colspan="colSpan">
          <table>
              <tr class="leve" :class="levelClass">
                ...
                <td class="td3">{{model.namespace}}</td>
                <td class="td4">
                  <span :title="model.path" class="ellipsis">{{model.path}}</span>
                </td>
                <td class="td5">{{model.servicename}}</td>
                <td class="td6">{{model.serviceport}}</td>
                <td class="td7">
                  <a class="reset" href="javascript:;" @click="actionFunc(model)">Edit</a>
                  <i class="line"></i>
                  <a class="delete" href="javascript:;" @click="deleteFunc(model)">Delete</a>
                </td>
              </tr>
          </table>
        </td>
