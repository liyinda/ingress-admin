<template>
	<div class="tree-table">
		<div class="tree-head">
			<table>
				<tr>
					<td class="td1">Ingress Name</td>
					<td class="td2">Rule Host</td>
					<td class="td3"">Namespace</td>
					<td class="td4">Path</td>
					<td class="td5">Service Name</td>
					<td class="td6">Service Port</td>
					<td class="td7">Operation</td>
				</tr>
			</table>
		</div>
...
<style lang="less">
	.tree-table {
		...
		.td1 {width: 150px;padding-left:30px;}
		.td2 {width: 250px;}
		.td3 {width: 120px;}
		.td4 {width: 120px;}
		.td5 {width: 120px;}
